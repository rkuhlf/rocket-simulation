...
This model is basically a collection of all of the code I have written for Brazoswood's 2021-2022 Goddard program. Each year, we build a relatively large hybrid rocket from the ground up, launching it at White Sands, New Mexico after the school year. The program has improved steadily, ending with an estimated 35,000 foot launch last year.

So, I apologize for the disorderliness of the code, the somewhat confusing mix of design equations and prebuilt modelling functions, and the large number of outdated comments. Also, if you see McLeod referenced, he is the instructor for the program.
