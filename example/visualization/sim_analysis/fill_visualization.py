...
def plot_pressures(data: pd.DataFrame):
    ...
    plt.sca(ax1)
    plot_feature(data, feature_time, feature_fill_tank_pressure)
    plot_feature(data, feature_time, feature_run_tank_pressure)

    plt.sca(ax2)
    plot_feature(data, feature_time, feature_fill_tank_temperature)
    plot_feature(data, feature_time, feature_run_tank_temperature)
